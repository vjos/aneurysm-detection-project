...
def main():
    ...
    train_loader= DataLoader(trn, batch_size=args.batch_size, num_workers=args.workers, drop_last=True, shuffle=True)
    test_loader = DataLoader(tst, batch_size=args.batch_size//2, num_workers=args.workers, shuffle=False, drop_last=False)
